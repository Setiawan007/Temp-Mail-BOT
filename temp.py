...
def cek_update(version):
	check = r.get("https://raw.githubusercontent.com/Setiawan007/Temp-Mail-BOT/main/__version__").text.strip()
...
def main():
	...
	global num
	print("""
___________                     .__.__              __     ___  __________
\__    ___/        _____ _____  |__|  |           |  _ \  /   \ \__    __/
  |    |  ______  /     \\\__  \ |  |  |    ______ |_____||  |  |   |  |
  |    | /_____/ |  Y Y  \/ __ \|  |  |__ /_____/ |  _  ||  |  |   |  |
  |____|         |__|_|  (____  /__|____/         |____/  \___/    |__|
                       \/     \/

    * Author: Setiawan007
    * Github: https://github.com/Setiawan007

[01] GENERATE EMAIL RANDOM
[02] GENERATE EMAIL CUSTOM
[03] CEK UPDATE
[00] EXIT
""")
